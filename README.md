...
Version `0.7.8` packages the icon at both Signal K consumer locations: the App
...
```sh
npm install git+https://github.com/ajrm-marine-suite/signalk-ajrm-marine-snapshot.git#v0.7.8 --omit=dev --no-package-lock
```
